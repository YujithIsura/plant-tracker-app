...
import 'package:plant_tracker/screens/add_plant.dart';
import 'package:plant_tracker/screens/add_plant_stepper.dart';
import 'package:plant_tracker/screens/home_page.dart';
import 'package:plant_tracker/screens/login.dart';
import 'package:plant_tracker/screens/my_plants_page.dart';
...
class RouteConfiguration {
  ...
  static List<Path> paths = [
    ...
    Path(
      r'^' + '/add_plant',
      (context, match) => AddPlantPage(),
      openInSecondScreen: false,
    ),
    Path(
      r'^' + '/my_plants',
      (context, match) => MyPlantsPage(),
      openInSecondScreen: false,
    ),
    Path(
      r'^/',
